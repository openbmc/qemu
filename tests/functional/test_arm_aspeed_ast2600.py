...
class AST2600Machine(AspeedTest):
    ...
    ASSET_SDK_V905_AST2600 = Asset(
        'https://github.com/AspeedTech-BMC/openbmc/releases/download/v09.05/ast2600-default-obmc.tar.gz',
        '3f5f35577d5f181c0ac4b4f3a678ac29a03f8a161b496569b2d8560f9efc4582')

    def test_arm_ast2600_evb_sdk(self):
        self.set_machine('ast2600-evb')

        self.archive_extract(self.ASSET_SDK_V905_AST2600)
